...
public class DAOLayer {
	...
	public boolean insertUserBookDao(BookUser Book) {
	   ...
	   Object obj[]={Book.getBook_name(),Book.getBook_mobile(),Book.getBook_date(),Book.getBook_adhar(),Book.getEmail()};
	...
	public List<Receipt> findDataQuery(int pg_id, String book_adhar) {
		String qry="select pg_id,pg_name,pg_share,pg_price,pg_address,book_name,book_mobile,book_date,email from pg_details p,bookuser b where p.pg_id=? and b.book_adhar=?";
		//Receipt re=null;
